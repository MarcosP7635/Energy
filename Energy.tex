...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Energy_files/Energy_13_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Energy_files/Energy_14_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\PY{l+s+sd}{path for the command below. Only use a slash before the file}
\PY{l+s+sd}{name in Colab.}
\PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
